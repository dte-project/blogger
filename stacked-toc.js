...
(function(win, doc) {
    ...
    win['_' + fn] = function($) {
        ...
        function click(e) {
            ...
            _hook(this, 'click', [{}, headers, panels]);
        ...
        _hook(container, 'load', [$, headers, panels]);
    ...
    win['_' + (fn + 1)] = function($) {
        ...
        _hook(panels[term], 'load', [{}, headers, panels]);
    ...
    win['_' + fn + '_'] = function($) {
        ...
        _hook(entry, 'load.ad', [$, headers, panels]);
    };
    ...
    _hook(container, 'ready', [settings, headers, panels]);
